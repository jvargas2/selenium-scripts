...
try:
    ...
    # Making advanced search for Forensic Science courses
    print('Making advanced Forensic Science search...')
    ...
    subject_select.select_by_value('FRSC')
